...
aliases:["yml"],contains:b}}})();hljs.registerLanguage("yaml",e)})();/*! `clojure` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
}),n,{begin:"->|<-"}]}}})();hljs.registerLanguage("haskell",e)})();/*! `ini` grammar compiled for Highlight.js 11.5.1 */
...
;hljs.registerLanguage("python-repl",a)})();/*! `coq` grammar compiled for Highlight.js 11.5.1 */
...
})();hljs.registerLanguage("coq",e)})();/*! `php-template` grammar compiled for Highlight.js 11.5.1 */
